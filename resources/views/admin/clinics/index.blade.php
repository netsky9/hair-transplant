...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-1 mt-3">
        ...
        <div class="btn-toolbar">
            <a class="btn btn-sm btn-dark" href="{{ route('blog.admin.posts.create') }}">
    ...
    <table class="table table-sm table-striped border">
        ...
        @foreach($pagination as $item)
            <tr>
                ...
                <td>
                    <img src="{{ isset($item->miniature->path) ? $item->miniature->path : '/images/noimage.jpg' }}" alt="" class="image-miniature">
                </td>
                <td><a href="{{ route('clinics.admin.posts.edit', $item->id) }}">{{ $item->title }}</a></td>
